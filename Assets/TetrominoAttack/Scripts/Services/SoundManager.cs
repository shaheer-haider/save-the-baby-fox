...
public class SoundManager : MonoBehaviour
{
    ...
    /// the same time to eliminate the "shooting sound effect" (sound amplitude adds up and becomes too loud).
    /// </summary>
...
//        Debug.Log("Play sound: " + sound.clip.name + "; playCount: " + sound.simultaneousPlayCount + "; vol: " + vol); 
